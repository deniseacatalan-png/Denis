...
with upserted as (
  insert into public.properties (kml_id, title, slug, location, price, area, category, latitude, longitude, style_color, marker_color, summary, description_html, raw_description, is_published, display_order)
    values ('0AD44EE27B3607244220', 'LOTE VALLESCONDIDO CC', 'lote-vallescondido-cc', 'Valle Escondido, Club de Campo Fácil', 'USD 74.000', '4.301 m²', 'vendido', -40.1622053329986, -71.30048879024898, '000000', '#000000', '. Terreno en Valle Escondido Club de Campo – 4.301 m² Ubicación: Valle Escondido, Club de Campo Fácil acceso desde el portal del barrio - uf 23 - linda con espacio verde, vegetación autóctona- Amenities: Canch...', '<p class="MsoNormal"><b><i><u>. Terreno en Valle Escondido Club de Campo – 4.301
...
with upserted as (
  insert into public.properties (kml_id, title, slug, location, price, area, category, latitude, longitude, style_color, marker_color, summary, description_html, raw_description, is_published, display_order)
    values ('07363507D0370F197F50', 'TERRENO CIPRESES', 'terreno-cipreses', 'Barrio Cipreses, San Martín de los Andes Dimensiones: 25 x 45 metros', 'USD 700.000', '1.125 m²', 'vendido', -40.15075868523154, -71.3375820890827, '000000', '#000000', 'Terreno en Cipreses – 1.125 m² CON COSTA DE ARROYO TRABUNCO Ubicación: Barrio Cipreses, San Martín de los Andes Dimensiones: 25 x 45 metros Servicios: Todos los servicios disponibles (luz, agua, gas y cloacas)...', '<p class="MsoNormal"><b><i><u>Terreno en Cipreses – 1.125 m² CON COSTA DE ARROYO TRABUNCO</u></i></b><br></p><p class="MsoNormal"><br></p><div><span>&nbsp;</span><b>Ubicación:</b> Barrio Cipreses, San Martín de los Andes<br></div><div><span>&nbsp;</span><b>Dimensiones:</b> 25 x 45 metros<br></div><div><span>&nbsp;</span><b>Servicios:</b> Todos los servicios
...
with upserted as (
  insert into public.properties (kml_id, title, slug, location, price, area, category, latitude, longitude, style_color, marker_color, summary, description_html, raw_description, is_published, display_order)
    values ('051F906DFE3F521C0268', 'CASA VEGA SAN MARTIN', 'casa-vega-san-martin', 'Vega Maipu, San Martin de los Andes', 'Consultar', 'Superficie a confirmar', 'venta', -40.13436393632432, -71.28797917579566, 'ab47bc', '#ab47bc', '', '', '', true, 18)
    on conflict (kml_id) do update set
      title = excluded.title,
      slug = excluded.slug,
      location = excluded.location,
...
with upserted as (
  insert into public.properties (kml_id, title, slug, location, price, area, category, latitude, longitude, style_color, marker_color, summary, description_html, raw_description, is_published, display_order)
    values ('03BFE452803F521C4137', 'CABAÑAS VEGA SAN MARTIN', 'cabanas-vega-san-martin', 'Vega Maipu, San Martin de los Andes', 'Consultar', 'Superficie a confirmar', 'venta', -40.13456806701437, -71.28786930294132, 'ab47bc', '#ab47bc', '', '', '', true, 19)
    on conflict (kml_id) do update set
      title = excluded.title,
      slug = excluded.slug,
      location = excluded.location,
